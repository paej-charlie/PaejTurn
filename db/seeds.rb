landmark_attributes = [
    ...
    },
    {
        ...
        The present building, 551 Fourth Avenue, was constructed between 1910 and 1914.  The structure, a three-story brick building, consists of 40 hotel rooms with multiple lightwells, a 5,000 square foot basement with redwood rafters and several street level stores.

        Between 1914 and 1930, the hotel was first the New York Hotel and then the Midland. The early street level businesses were varied. Between 1917 and 1928, many Chinese companies, including the Golden Gate Company, occupied the space at 555 Fourth Avenue and used it primarily for storage of their excess goods. 
        ...
        The Pacifica Hotel has undergone many changes, rebrandings and resurrections since 1910, and after many soil and earthquake tests is now listed as one of the safest buildings in the Gaslamp.
    ...
    },
    {
        ...
        On the morning of September 4, 1888 fire totally destroyed the new Backesto Building. It was described by the San Diego Union as the most disastrous fire in San Diego’s history. Spectators had to flee for their lives, but fortunately all tenants escaped and no loss of life occurred. Owners Klauber and Levi lost their entire stock valued at $250,000.
    ...
    },
    {
        ...
        Throughout the years, the first floor has housed saloons, wholesale and retail liquor stores, gun shops, book stores, a seed store, dry goods stores, billiard parlors, barbers, tobacco stores, a laundry, shoe repair shops, restaurants, a chili con carne factory and the Wells Fargo Express Company. In 1974, the San Diego Ballet used the second floor, with its elegant wood floors as their headquarters.

        Throughout its colorful history the I.O.O.F. building has hosted many dignitaries, but perhaps one of the most notable was King Kalakaua of Hawaii. He arrived in 1890, as he was touring the mainland and there was talk of Hawaii becoming a state.  He sat by one of the magnificent arched windows and, unfortunately and literally, caught his death of a cold. 
